...
public class Text1   {
    ...
    private ArrayList<Item1> result;
    ...
    public void setResult(ArrayList<Item1> result) {
        this.result = result;
    }
    ...
    public ArrayList<Item1> getResult() {
        return result;
    }
    ...
    public static class ResultEntity   {
        ...
        protected ArrayList<Item1> subregions;
        ...
        public void setSubregions(ArrayList<Item1> subregions) {
        ...
        public ArrayList<Item1> getSubregions() {
            return subregions;
        }
...
//    }
//
//    protected Text1(Parcel in) {
//        this.message = in.readString();
//        this.status = in.readString();
//        this.result = in.createTypedArrayList(Item1.CREATOR);
//    }

//    public static final Parcelable.Creator<Text1> CREATOR = new Parcelable.Creator<Text1>() {
//        public Text1 createFromParcel(Parcel source) {
//            return new Text1(source);
//        }
//
//        public Text1[] newArray(int size) {
//            return new Text1[size];
//        }
//    };
}
